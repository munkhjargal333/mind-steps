      ...
      <div className="container max-w-5xl mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-0 border border-foreground/10">
          <div className="p-8 md:p-12 space-y-8 md:border-r border-foreground/10 bg-background/40">
            <h3 className="font-serif font-black text-xl uppercase italic text-brand-amber underline underline-offset-8 decoration-2">✓ ЗОРИУЛАГДСАН</h3>
            <ul className="space-y-4 font-serif italic text-lg opacity-80">
          ...
          <div className="p-8 md:p-12 space-y-8 bg-brand-stone/5">
            <h3 className="font-serif font-black text-xl uppercase italic text-muted-foreground underline underline-offset-8 decoration-2">✕ ЗОРИУЛАГДААГҮЙ</h3>
            <ul className="space-y-4 font-serif italic text-lg opacity-60">
        ...
        <div className="mt-12 p-8 border-4 border-double border-foreground/20 bg-background text-center space-y-2">
          <p className="font-serif font-black text-[10px] uppercase tracking-[0.5em] text-brand-terracotta">ЧУХАЛ АНХААРУУЛГА</p>
          <p className="font-serif text-sm italic text-muted-foreground max-w-2xl mx-auto">

      ...
      <div className="container max-w-5xl mx-auto px-6 md:px-12">
        ...
        <div className="mb-12 space-y-3 max-w-xl">
          <div className="inline-block border-2 border-foreground px-3 py-1">
            <span className="font-mono text-[9px] font-bold tracking-[0.4em] uppercase">
              Онцлох шинжилгээ
            </span>
          </div>
          <h2 className="font-mono text-3xl md:text-5xl font-black tracking-tighter uppercase italic leading-[0.9]">
            Та юу ойлгож эхлэх вэ?
          </h2>
          <p className="font-mono text-sm italic text-foreground/55 leading-relaxed">
          ...
          {FEATURES.map((feat, idx) => (
            ...
            >
              <div className="md:col-span-1 shrink-0">
                <span className="font-mono font-black text-[10px] tracking-[0.3em] text-foreground/25">
                  {String(idx + 1).padStart(2, '0')}
                </span>
              </div>
              <div className="md:col-span-5">
                <h3 className="relative inline font-mono font-black text-base md:text-lg tracking-tight italic leading-snug">
              ...
              <div className="md:col-span-6">
                <p className="font-mono text-sm text-foreground/55 leading-relaxed italic">
                  {feat.desc}
                </p>
              </div>
            </div>
        ...
        <div className="mt-10 pt-5 border-t border-dashed border-foreground/15 text-center">
          <p className="font-mono text-[9px] uppercase tracking-[0.5em] font-bold opacity-20">

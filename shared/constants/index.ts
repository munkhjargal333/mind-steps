...
export const STEP_CONFIG: Record<string, StepCopy> = {
  stress: {
    ...
    inner: {
      ...
      placeholder: 'дахиад дахин шалгах, хэт их бодож төлөвлөх, өөр зүйлд сатаарах, эсвэл бүр гацаад юу ч хийж чадахгүй болох...',
    },
    meaning: {
      q: 'Яг үнэндээ чи юу өөрчлөгдөөсэй гэж хүсэж байна?',
      placeholder: 'арай тайван баймаар, бүхнийг ганцаараа үүрэхгүй баймаар, зүйлс бага зэрэг удаашраасай...',
    },
  },
  ...
  loneliness: {
    surface: {
      ...
      placeholder: 'хүмүүсийн дунд байвч ганцаараа мэт мэдрэгдэх, ойлгогдохгүй юм шиг санагдах, хуваалцах зүйл дотроо үлдэх...',
    },
    inner: {
      q: 'Тэр мэдрэмж төрөх үед чи ихэвчлэн хүмүүст ойртдог уу, эсвэл өөрийгөө татаж холдуулдаг уу?',
      placeholder: 'хэн нэгэнд бичих гэж байгаад больчих, утсаа оролдох, хүнээс зайлсхийх, дотогшоо улам хаагдах...',
    },
    meaning: {
      q: 'Яг үнэндээ чи хэзээ “би ганцаараа биш” гэж мэдэрдэг вэ?',
      placeholder: 'хэн нэгэн үнэхээр анхаарч сонсох үед, хамт чимээгүй байсан ч тухтай санагдах үед, ойлгогдож байна гэж мэдрэгдэх үед...',
    },
  },
  ...
  self_doubt: {
    ...
    inner: {
      ...
      placeholder: 'баталгаа дахин дахин хайх, шийдвэрээ хойшлуулах, хэт их мэдээлэл цуглуулах, эхлэхээсээ өмнө больчих...',
    },
    meaning: {
  ...
  fear: {
    ...
    inner: {
      ...
      placeholder: 'урьдчилж бэлтгэх, бүхнийг хэт их тооцоолох, бодохоос зайлсхийх, хэнд ч хэлэхгүй дотроо хадгалах...',
    },
    meaning: {
      q: 'Яг үнэндээ чи юуг хамгаалж үлдэхийг зориж байна вэ?',
      placeholder: 'хайртай хүмүүсээ хамгаалах, өөртөө итгэх итгэлээ алдахгүй байх,  юу ч болсон давж чадна гэсэн мэдрэмж...',
    },
  },
